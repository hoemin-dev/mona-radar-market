...
fn notice_detail(app: AppHandle, bid_no: String, bid_ord: String) -> Result<Value, String> {
    ...
    Ok(json!({"notice":notice,"items":items,"basis":basis}))
}
